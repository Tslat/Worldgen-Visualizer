...
public class DimensionSettingsScreen extends Screen {
	...
	protected void init() {
		...
		addButton(rootWidget = new JsonObjectsField(guiRootX, guiRootY + 20, I18n.format(TITLE.getKey()), null, currentSettings, editedSettings, new StringTextComponent(""), this::addButton).setSaveFunction(DimensionSettingsScreen::saveChanges));
	}
