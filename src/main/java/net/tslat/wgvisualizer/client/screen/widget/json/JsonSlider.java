...
public class JsonSlider extends Slider implements JsonValueWidget<JsonPrimitive> {
	...
	public JsonSlider(int xPos, int yPos, String fieldId, ITextComponent prefix, ITextComponent suf, double minVal, double maxVal, double currentVal, double defaultValue, boolean showDec, IPressable handler) {
